...
class AccountUtility {
     ...
     * 地址生成逻辑
     ...
     6.r6就是地址
     */
    static func publickeyHashToAddress(pubkeyHash:String)->String?{
     ...
     * @return
     */
    static func  addressToPubkeyHash( address:String)->String?{
    ...
    /**
     公钥转公钥hash
    */
    static func publicKeyToPublicKeyHash(publicKey:String)->String?{
    ...
    /**
     地址正确性校验
    */
   static func verifyAddress(address:String) ->Int{
